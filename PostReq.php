        ...
        <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
            ...
            <?php if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) : ?>
                <div class="mt-6 p-4 bg-green-100 border border-green-400 rounded">
                    <h2 class="text-lg font-semibold mb-2">Submitted Job Listing</h2>
                    <p><strong>Title:</strong> <?= htmlspecialchars($_POST['title']) ?></p>
                    <p><strong>Description:</strong> <?= nl2br(htmlspecialchars($_POST['description'])) ?></p>
                </div>
            <?php endif; ?>
        </div>
    </div>
